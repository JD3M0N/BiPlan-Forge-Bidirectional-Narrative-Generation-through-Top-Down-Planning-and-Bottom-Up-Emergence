    ...
    def run(
        ...
        return self.provider.generate_structured(
            system_instruction=(
                ...
                "Choose the chapters required to fulfill the qualitative narrative profile and meet its "
                "explicit minimum event count. Do not target or infer word or chapter budgets. "
                ...
                "Every event must change the story state through concrete effects; never inflate the graph "
                "by dividing one unchanged action into multiple events. Expansive plans require one "
                "earlier event with at least two outgoing causal dependencies and a later event with at "
                "least two incoming causal dependencies; independent parallel roots are not a branch. "
                "PAYOFF_OF CONTRACT: "
